    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Register To Alumni</div>
         ...
         <select id="course" type="text" class="form-control form-item form-select" style="max-width:400px; margin-bottom:6px;" name="course" value="{{ old('name') }}">
                        ...
                        <div class="form-group"  >
                            <div class="col-md-6 col-md-offset-4" >
                                <button type="submit" class="btn btn-default"  >
                                    <i class="fa fa-btn fa-user " style="color:maroon;"></i> Register
                                </button>
                            </div>
                        </div>
                    </form>
